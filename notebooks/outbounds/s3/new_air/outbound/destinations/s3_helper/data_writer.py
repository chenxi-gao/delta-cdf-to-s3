...
class S3DataWriter:
    ...
    def __init__(self):
        ...
        # No parent temp dir validation is required; TemporaryDirectory will raise on failure
    ...
    def write_to_s3(
        ...
        **kwargs,
        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix=f"_tmp_{file_name}_") as tmp_output_dir:
